...
g++ -Wall -std=c++11 -g in_file.cpp -o out_file -lSDL2 -lSDL2_image -lGLEW -lGL -lSOIL
...
void Draw(GLuint shaderProgram, GLint uniModel)
{
	...
	model = glm::rotate( model, ( (float)clock() / (float)CLOCKS_PER_SEC * 180.0f ) , glm::vec3( 0.0, 0.0f, 1.0f ) ); 
